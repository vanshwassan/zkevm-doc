...
\input{\zkevmdir/architecture/latex/simple-state-machine}
\input{\zkevmdir/architecture/latex/microVM-architecture} %divide and conquer, plookup, permutation
\input{\zkevmdir/architecture/latex/individual-state-machines}
\input{\zkevmdir/architecture/latex/main-state-machine}
\input{\zkevmdir/architecture/latex/prover-workflow}
